...
namespace OliveGenerator
{
    internal class ReadmeFileGenerator
    {
        internal static string Generate()
        {
            ...
            r.AppendLine($"The {Context.EndpointType.FullName}.Endpoint package is generated by « Olive Data End Point Generator ».");
            r.AppendLine();
        ...
        static string GenerateQuickReference()
        {
            ...
            r.AppendLine($"    await new {Context.EndpointName}(typeof({Context.ReplicatedData.FirstOrDefault()?.GetType().FullName}).Assembly).Subscribe();");
            r.AppendLine("}");
            r.AppendLine();
